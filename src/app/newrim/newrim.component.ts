 ...
 */
  ...
  onSubmit() {
    ...
    formData.append(
      'modelname',
      this.newrimForm.value['modelname'].toUpperCase()
    );
    formData.append(
      'description',
      this.newrimForm.value['description'].toUpperCase()
    );
    formData.append(
      'partsupl',
      this.newrimForm.value['partsupl'].toUpperCase()
    );
    ...
    formData.append(
      'labelColor',
      this.newrimForm.value['labelColor'].toUpperCase()
    );
    formData.append('photo', this.file);
    formData.append('favorite', this.newrimForm.value['favorite'].toString());
    ...
    this.rim.save(formData).subscribe((response) => {
      ...
      if (_response.message === 'Rim already exists') {
        ...
        Swal.fire('¡Guardado!', 'La marca se guardó correctamente', 'success');
        //Swal.close();
        this.dialog.closeAll();
      }
    });
